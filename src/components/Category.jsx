...
import { addVideoCategoryApi, deleteCategoryyApi, getVideoApi, getVideoCategoryApi, updateCategoryAPI } from '../services/allApi';
...
<div className="border rounded p-4 m-3" droppable="true" onDragOver={e=>dragOver(e)} onDrop={e=>videoDropped(e,category?.id)} key={category}>
    ...
    <Row>
      {
        category?.allVideos?.length>0?category?.allVideos.map(card=>(
          <Col sm={12} className='mb=3' draggable onDragStart={e=>videoDragStarted(e,card.id,category.id)} key={card}>
